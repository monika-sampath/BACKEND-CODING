A step by step Back end process to complete the Learning Management System in been created.
API is created with mvc pattern.
.env file is ignored for security purpose.
PostMan is used to check the api and crud function to connect with MongoDb Compass.
